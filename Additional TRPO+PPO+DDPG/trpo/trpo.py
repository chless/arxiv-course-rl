"""
[Reference] https://github.com/openai/spinningup/pull/209/files
...
import openai.spinup.algos.pytorch.trpo.core as core
from openai.spinup.utils.logx import EpochLogger
from openai.spinup.utils.mpi_pytorch import mpi_avg_grads, sync_params, setup_pytorch_for_mpi
from openai.spinup.utils.mpi_tools import mpi_fork, proc_id, mpi_statistics_scalar, num_procs
...
if __name__ == '__main__':
    ...
    from openai.spinup.utils.run_utils import setup_logger_kwargs
